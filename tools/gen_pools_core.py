...
HABITS = [
    ...
    "hums the Sunny Fizz jingle when nervous. Does it louder when someone mentions it.",
...
# ============================================================
# QUIRKS (~35) — observable behavioral oddities, not habits
# ============================================================

QUIRKS = [
    "laughs one beat too late, like the joke needs processing time",
    "addresses every piece of equipment by model number, never by nickname",
    "always enters rooms right foot first. Will back up and restart if they get it wrong",
    "speaks in present tense about things that happened years ago",
    "knows everyone's birthday. Nobody told them. Nobody asks how",
    "gives nicknames to everything. The generator is Margaret. The drill is Steve",
    "stands exactly one arm-length from everyone. Measured. Consistent",
    "writes left-handed but throws right-handed. Claims not to notice",
    "remembers exact dates for everything. Not years. Dates. Day of the week",
    "finishes other people's sentences. Usually wrong. Doesn't stop",
    "cannot walk past a closed door without trying the handle",
    "takes notes during casual conversation. In shorthand nobody else can read",
    "sleepwalks to the same spot every time. The spot has no significance anyone can identify",
    "talks to plants. Argues with them. Occasionally concedes a point",
    "can't sit in a chair normally. Sideways, backward, cross-legged on the seat. Never standard",
    "blinks exactly twice when lying. Doesn't know about it. Everyone else does",
    "hums a different song each day. The songs follow a pattern nobody's cracked",
    "straightens things on other people's desks. Without asking. Without noticing",
    "takes exactly three sips of any drink, then puts it down. Always three",
    "points with their middle finger instead of their index. Cultural or accidental, nobody asks",
    "answers questions with questions. Not evasively. Genuinely confused by the concept of a direct answer",
    "closes their eyes when listening to something important. Opens them when they've decided",
    "walks in straight lines. Turns at right angles. Won't take diagonals through a room",
    "sniffs food before eating it. Every bite. Even food they prepared themselves",
    "refers to themselves in the third person under stress. Doesn't notice the switch",
    "touches the top of every doorframe when passing through. The tall ones and the short ones",
    "keeps exact change on them at all times. Counts it when anxious",
    "speaks louder in cold rooms and quieter in warm ones. Nobody's pointed it out",
    "reads signs aloud. All of them. Even the ones they've read a hundred times",
    "arranges their food by color before eating. Eats lightest to darkest",
    "tilts their head to the same side every time they're asked a question",
    "never uses contractions when angry. Full words. Every syllable deliberate",
    "whistles the same five-note phrase when entering a dark room. Different from their usual whistle",
    "draws circles on foggy surfaces. Always circles. Perfect ones",
    "holds doors open for people who are too far away. Waits. Doesn't mind",
]


# ============================================================
# LIKES (~35) — specific preferences that bring comfort
# ============================================================

LIKES = [
    "black coffee. The blacker the better. Sugar is an insult",
    "the sound the generator makes between cycles. Two seconds of almost-silence",
    "old Earth music. Pre-colony recordings. The crackle is part of it",
    "being underestimated. It's useful. It's also comfortable",
    "the view from the north observation post at 0400. Nobody else is there",
    "working with their hands. Screens are fine. Hands are better",
    "dogs. Any dogs. Colony dogs get treats smuggled from the mess hall",
    "rain. Never seen it on Erebus. Remembers it from before. Plays recordings",
    "the smell of machine oil. Grew up around engines",
    "being alone. Not lonely. Alone. There's a difference people don't respect",
    "math. The numbers don't lie. Everything else does, but the numbers don't",
    "letters from home. Even the old ones. Reads them in order. Starts over",
    "NutriLoaf. Actually likes it. Won't admit this to anyone",
    "the cold. Born in it. Comfortable in it. The heated quarters feel wrong",
    "maps. Collects them. Draws them. A map is a promise that somewhere else exists",
    "the sound of welding. The hiss and the light. Learned to love it young",
    "bad jokes. The worse the better. Collects them. Has a notebook",
    "small spaces. Feels safe in them. The maintenance crawlways are a comfort",
    "the color blue. Anything blue. Painted their bunk frame blue with stolen paint",
    "routine. Same wake-up time. Same breakfast. Same route to shift. Predictability is kindness",
    "teaching. Explaining something to someone who wants to learn. The patience is genuine",
    "silence after a long shift. Not conversation. Not music. Just the hum of the colony at rest",
    "mechanical clocks. The ticking. Built one from salvage. It loses six minutes a day",
    "the taste of salt. Eats it on everything. Carries a packet in their pocket",
    "night shifts. Fewer people. Fewer questions. The colony belongs to them for eight hours",
    "knives. Not weapons. Tools. Good steel. Keeps three. Each has a name",
    "old photographs. Other people's. Found in bunks, in corridors, in cargo. Keeps them all",
    "thunderstorms. Played recordings of them during the transit. The other passengers complained",
    "hot showers. Five minutes of hot water is worth more than a day's pay",
    "the smell of bread. The hydroponics bay grows wheat sometimes. Those are good weeks",
    "reading. Anything. Ration packet ingredients. Safety manuals. Equipment specs. The words are the point",
    "heights. Not afraid of them. Drawn to them. Climbs the relay tower when nobody's watching",
    "the moment just before sleep when the brain lets go. Chases that feeling all day",
    "warm hands. Holds their mug long after the coffee's gone. Just for the heat",
    "stars. Memorized the visible constellations from the viewport. Named three that aren't in any catalog",
]


# ============================================================
# DISLIKES (~35) — specific aversions that trigger discomfort
# ============================================================

DISLIKES = [
    "the sound of chewing. Any chewing. Eats alone because of it",
    "Mammona's motto. Hearing it. Reading it. The way it shows up everywhere",
    "being touched without warning. Fine if asked. Flinches if surprised",
    "small talk. Can't do it. Won't do it. Sits in silence instead",
    "the color of the emergency lighting. Reminds them of somewhere else",
    "authority for its own sake. Follows orders that make sense. Questions the rest",
    "Sunny Fizz. The taste. The mascot. The corporate cheerfulness of it",
    "people who sleep easily. The resentment is irrational. The resentment is real",
    "the drill harmonic. Specific frequency. Makes their teeth ache",
    "clocks. Time moves wrong on Erebus. The clocks just confirm it",
    "eye contact with strangers. Fine with friends. With strangers it feels like a threat",
    "HERMES's voice. Not the words. The tone. The way it sounds like it cares",
    "loud environments. The mess hall during peak shift is punishment",
    "being photographed. Won't explain. Gets hostile if pushed",
    "pity. Can handle anger, contempt, indifference. Pity is the one that breaks them",
    "mornings. Never been a morning person. Erebus doesn't have mornings but the shift schedule does",
    "the word 'team.' It's always followed by something that benefits someone else",
    "fluorescent lighting. Gives them headaches. The colony is entirely fluorescent",
    "crowds. Anything over eight people in a room. Finds an excuse to leave",
    "apologies. Not because they don't value them. Because most apologies here are Mammona's",
    "the taste of recycled water. Can taste the chemicals. Nobody else admits they can",
    "NutriLoaf. The texture. The smell. The way it pretends to be food",
    "being woken up. By anything. For any reason. The transition from sleep to here is violent",
    "the sound of airlocks. The hiss and the seal. Something about finality",
    "people who talk about the weather on Erebus. The weather is cold. It's always cold. There's nothing to discuss",
    "compliments. Doesn't trust them. Waits for the ask that follows",
    "music in common areas. Not all music. The cheerful kind. The kind that pretends things are fine",
    "new boots. Breaking them in on Erebus takes two weeks of agony",
    "the quarterly Mammona survey. Twenty questions about 'workplace satisfaction.' The irony isn't lost on anyone",
    "optimists. Not personally. Professionally. Optimism on Erebus is a liability",
    "the smell of the bore shaft. Metallic, organic, wrong. Lingers in clothing for hours",
    "being called by their last name. Reminds them of their father. Their father was not kind",
    "loose screws. The sound of something rattling in a wall. Stops everything until it's found",
    "the color yellow. Mammona yellow. Caution tape yellow. Sunny Fizz mascot yellow",
    "meetings. Any meetings. Information could be an email. Or a shout down the corridor",
]
