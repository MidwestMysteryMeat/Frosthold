...
REWARD_TYPES = [
    ...
    "a neural chip bypass tool",
    "passage off-planet (one seat, non-transferable)",
    "a map of the bore shaft that goes deeper than official surveys",
    "thermal core extraction rights for Section F",
    "Mammona debt reduction (40% of remaining balance)",
    "a functioning cryo pod",
    "an ally inside MasTema",
    "a voidbloom antidote (unverified)",
    "schematics for equipment Mammona doesn't ship to postings",
    "the previous site manager's journal",
    "access codes for HERMES diagnostic mode",
]
